...
class Composition(FHIRResource):
    ...
    type: Optional[CodeableConcept] = None  # The type of document - a Catalog.
    category: Optional[CodeableConcept] = None  # The content (narrative and data) associated with the section.
    date: Optional[str] = None  # When the Catalog was created.
    ...
    subject: Optional[Reference] = None  # Who or what the composition is about. The composition can be about a person, (patient or healthca...
