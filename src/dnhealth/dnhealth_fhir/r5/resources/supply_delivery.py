...
from dnhealth.dnhealth_fhir.types import CodeableConcept, Extension, Identifier, Period, Quantity, Reference, Timing
...
class SupplyDelivery(FHIRResource):
    ...
    suppliedItem: Optional[List[SupplyDeliverySuppliedItem]] = field(default_factory=list)  # The item that is being delivered or has been supplied.
