...
from dnhealth.dnhealth_fhir.types import Age, BackboneElement, CodeableConcept, Coding, ContactDetail, Dosage, Duration, Expression, Extension, Identifier, Period, Quantity, Range, Reference, RelatedArtifact, Timing, UsageContext
...
class ActivityDefinition(FHIRResource):
    ...
    date: Optional[str] = None  # The date  (and optionally time) when the activity definition was last significantly changed. The ...
